...
- [`DeepPatientLevelPrediction-package`](https://ohdsi.github.com/DeepPatientLevelPrediction/reference/DeepPatientLevelPrediction.md)
  [`DeepPatientLevelPrediction`](https://ohdsi.github.com/DeepPatientLevelPrediction/reference/DeepPatientLevelPrediction.md)
  : DeepPatientLevelPrediction
- [`camelCaseToSnakeCase()`](https://ohdsi.github.com/DeepPatientLevelPrediction/reference/camelCaseToSnakeCase.md)
  : Convert a camel case string to snake case
- [`camelCaseToSnakeCaseNames()`](https://ohdsi.github.com/DeepPatientLevelPrediction/reference/camelCaseToSnakeCaseNames.md)
  : Convert the names of an object from camel case to snake case
- [`checkFileExists()`](https://ohdsi.github.com/DeepPatientLevelPrediction/reference/checkFileExists.md)
  : helper function to check if a file exists
- [`checkHigher()`](https://ohdsi.github.com/DeepPatientLevelPrediction/reference/checkHigher.md)
  : helper function to check that input is higher than a certain value
- [`checkHigherEqual()`](https://ohdsi.github.com/DeepPatientLevelPrediction/reference/checkHigherEqual.md)
  : helper function to check that input is higher or equal than a
  certain value
- [`checkIsClass()`](https://ohdsi.github.com/DeepPatientLevelPrediction/reference/checkIsClass.md)
